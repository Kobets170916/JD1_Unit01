...
public class Oven extends Appliance {
	...
	public Oven(String name, double powerConsumption, double weight,
	...
	public String toString() {
		return "Oven [powerConsumption=" + powerConsumption + ", weight=" + weight +
				", capacity=" + capacity + ", depth=" + depth + ", height=" +
				height + ", width=" + width + "]";
	}
