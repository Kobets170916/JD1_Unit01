...
public class Laptop extends Appliance {
	public static final String BATTERY_CAPACITY = null;
	public static final String DISPLAY_INCHS = null;
	public static final String CPU = null;
	public static final String OS = null;
	public static final String SYSTEM_MEMORY = null;
	...
	public String toString() {
		return "Laptop [batteryCapacity=" + batteryCapacity + ", os=" + os +
				", memoryRom=" + memoryRom	+ ", systemMemory=" + systemMemory + 
				", cpu=" + cpu + ", displayInchs=" + displayInchs + "]";
	}
